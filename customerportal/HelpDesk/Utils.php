...
function getPicklist($picklist_name)
{
	...
	$ticket_picklist_array_loc = array();
	foreach($ticket_picklist_array as $val)
	    $ticket_picklist_array_loc[] = getTranslatedString($val);
	$_picklist_cache[$picklist_name] = $ticket_picklist_array_loc;

	return $ticket_picklist_array_loc;
