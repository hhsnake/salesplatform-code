...
// SalesPlatform.ru begin: Added flexibility to specify end var name
function getrecurringObjValue($end_request_var_name = 'calendar_repeat_limit_date')
...
// SalesPlatform.ru begin: Added flexibility to specify end var name
		if(!empty($_REQUEST[$end_request_var_name])) {
			$endDate = $_REQUEST[$end_request_var_name];
