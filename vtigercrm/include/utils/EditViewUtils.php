		...
		if(!empty($picklistValues)){
			foreach($picklistValues as $order=>$pickListValue){
				...
				if(isset($_REQUEST['file']) && $_REQUEST['file'] == 'QuickCreate'){
					...
					//$options[] = array(htmlentities(getTranslatedString($pickListValue),ENT_QUOTES,$default_charset),$pickListValue,$chk_val );	
					$options[] = array(htmlentities(getTranslatedString(html_entity_decode($pickListValue)),ENT_QUOTES,$default_charset),$pickListValue,$chk_val );
					// SalesPlatform.ru end
				}else{
					// SalesPlatform.ru begin
					//$options[] = array(getTranslatedString($pickListValue),$pickListValue,$chk_val );
					$options[] = array(getTranslatedString(html_entity_decode($pickListValue)),$pickListValue,$chk_val );
					// SalesPlatform.ru end
				}
			}
