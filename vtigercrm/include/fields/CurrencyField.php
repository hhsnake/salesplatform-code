...
// SalesPlatform.ru begin
        private function _formatDecimalPart($value) {
            if(strlen($value) > $this->numberOfDecimal)
                $value = substr($value, 0, $this->numberOfDecimal);
            elseif(strlen($value) < $this->numberOfDecimal) {
                $value = str_pad($value, $this->numberOfDecimal, '0');
            }
            return $value;
        }
// SalesPlatform.ru end
