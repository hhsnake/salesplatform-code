...
class VtigerModuleOperation extends WebserviceEntityOperation {
	...
	public function describe($elementType){
		...
		$fields = $this->getModuleFields();
				...
				"deleteable"=>$deleteable,"retrieveable"=>$retrieveable,"fields"=>$fields, "inventories"=>$invResData,
	...
	function getDescribeFieldArray($webserviceField){
		...
		require 'modules/'.$this->meta->getTabName()."/language/$current_language.lang.php";
