	...
	public function getListViewEntries($pagingModel) {
		...
		for($i=0; $i<$noOfRecords; $i++) {
			...
			$module = $dependentPicklists[$i]['module'];
                        $sourcefieldlabel = $dependentPicklists[$i]['sourcefieldlabel'];
                        $targetfieldlabel = $dependentPicklists[$i]['targetfieldlabel'];        
			...
			$record->set('sourceLabel', vtranslate($module, $module));
                        $record->set('sourcefieldlabel', vtranslate($sourcefieldlabel, $module));
                        $record->set('targetfieldlabel', vtranslate($targetfieldlabel, $module));
