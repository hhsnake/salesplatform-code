...
// SalesPlatform.ru begin
		$this->db->query("insert into vtiger_field values (6,".$this->db->getUniqueID("vtiger_field").",'inn', 'vtiger_account', 1, 1, 'inn', 'INN', 1, 2, '', 30, 23, 9, 1, 'V~O', 3, NULL, 'BAS', 0)");
		$this->db->query("insert into vtiger_field values (6,".$this->db->getUniqueID("vtiger_field").",'kpp', 'vtiger_account', 1, 1, 'kpp', 'KPP', 1, 2, '', 30, 24, 9, 1, 'V~O', 3, NULL, 'BAS', 0)");
// SalesPlatform.ru end
