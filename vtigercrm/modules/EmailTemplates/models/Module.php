...
class EmailTemplates_Module_Model extends Vtiger_Module_Model {
	...
	public function getAllModuleEmailTemplateFields() {
		...
		$option = array(vtranslate('Current Date', $module), '$custom-currentdate$');
		$allFields[] = $option;
		$option = array(vtranslate('Current Time', $module), '$custom-currenttime$');
		$allFields[] = $option;
		$allOptions[vtranslate('LBL_GENERAL_FIELDS', $module)] = $allFields;
		return $allOptions;
	}
