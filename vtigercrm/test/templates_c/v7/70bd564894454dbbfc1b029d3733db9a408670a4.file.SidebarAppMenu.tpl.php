<?php /* Smarty version Smarty-3.1.7, created on 2017-07-14 11:29:16
         compiled from "/u01/www/vt701/includes/runtime/../../layouts/v7/modules/Vtiger/partials/SidebarAppMenu.tpl" */ ?>
<?php /*%%SmartyHeaderCode:1524555740596880dc0fbbc8-09695285%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '70bd564894454dbbfc1b029d3733db9a408670a4' => 
    array (
      0 => '/u01/www/vt701/includes/runtime/../../layouts/v7/modules/Vtiger/partials/SidebarAppMenu.tpl',
      1 => 1500018753,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '1524555740596880dc0fbbc8-09695285',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_596880dc15e49',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_596880dc15e49')) {function content_596880dc15e49($_smarty_tpl) {?>
...
_modules_dropdownMenu" data-height="0.34">
                    ...
                    <?php $_smarty_tpl->tpl_vars['PDFTEMPLATES_MODULE_MODEL'] = new Smarty_variable(Vtiger_Module_Model::getInstance('SPPDFTemplates'), null, 0);?>
					<?php if ($_smarty_tpl->tpl_vars['PDFTEMPLATES_MODULE_MODEL']->value&&$_smarty_tpl->tpl_vars['USER_PRIVILEGES_MODEL']->value->hasModulePermission($_smarty_tpl->tpl_vars['PDFTEMPLATES_MODULE_MODEL']->value->getId())){?>
						<li>
							<a href="<?php echo $_smarty_tpl->tpl_vars['PDFTEMPLATES_MODULE_MODEL']->value->getDefaultUrl();?>
">
								<span class="fa vicon-documents module-icon"></span>
								<span class="module-name textOverflowEllipsis"> <?php echo vtranslate($_smarty_tpl->tpl_vars['PDFTEMPLATES_MODULE_MODEL']->value->getName(),$_smarty_tpl->tpl_vars['PDFTEMPLATES_MODULE_MODEL']->value->getName());?>
</span>
							</a>
						</li>
					<?php }?>
