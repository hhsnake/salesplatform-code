	...
	<div class="contents row-fluid">
		<form id="OutgoingServerForm" class="form-horizontal" data-detail-url="{$MODEL->getDetailViewUrl()}">
			...
			<table class="table table-bordered table-condensed themeTableColor">
				...
				<tbody>
                                        <tr><td width="25%"><label class="muted pull-right marginRight10px">{vtranslate('LBL_SENDMAIL', $QUALIFIED_MODULE)}</label></td>
                                        <td style="border-left: none;"><input type="checkbox" name="use_sendmail" {if $MODEL->isUseSendMailEnabled() neq 'false'}checked{/if}/></td></tr> 
					<tr><td><label class="muted pull-right marginRight10px"><span class="redColor">*</span>{vtranslate('LBL_SERVER_NAME', $QUALIFIED_MODULE)}</label></td>
					...
					{* SalesPlatform.ru begin optional fields *}
                                        <tr><td><label class="muted pull-right marginRight10px">{vtranslate('LBL_SERVER_PORT', $QUALIFIED_MODULE)}</label></td>
						<td style="border-left: none;"><input type="text" name="server_port" data-validation-engine='validate[funcCall[Vtiger_Base_Validator_Js.invokeValidation]' value="{$MODEL->get('server_port')}"</td></tr>
                                        <tr><td><label class="muted pull-right marginRight10px">{vtranslate('LBL_USER_NAME', $QUALIFIED_MODULE)}</label></td>
						<td style="border-left: none;"><input type="text" name="server_username" data-validation-engine='validate[funcCall[Vtiger_Base_Validator_Js.invokeValidation]' value="{$MODEL->get('server_username')}"</td></tr>
					<tr><td><label class="muted pull-right marginRight10px">{vtranslate('LBL_PASSWORD', $QUALIFIED_MODULE)}</label></td>
						<td style="border-left: none;"><input type="password" name="server_password" data-validation-engine='validate[funcCall[Vtiger_Base_Validator_Js.invokeValidation]' value="{$MODEL->get('server_password')}"</td></tr>
...
-                                               <td style="border-left: none;"><input type="password" name="server_password" data-validation-engine='validate[required]' value="{$MODEL->get('server_password')}"</td></tr>*}
					...
					{* SalesPlatform.ru begin *}
                                        <tr><td><label class="muted pull-right marginRight10px">{vtranslate('LBL_FROM_NAME', $QUALIFIED_MODULE)}</label></td>
                                                <td style="border-left: none;"><input type="text" name="from_name" data-validation-engine='validate[funcCall[Vtiger_Base_Validator_Js.invokeValidation]' value="{$MODEL->get('from_name')}"</td></tr>
                                        ...
                                        {* SalesPlatform.ru begin display checkbox *}
                                                <td style="border-left: none;"><input type="checkbox" name="smtp_auth" {if $MODEL->isSmtpAuthEnabled() neq 'false'}checked{/if}/></td></tr>
                                                {* <td style="border-left: none;"><input type="checkbox" name="smtp_auth" {if $MODEL->isSmtpAuthEnabled()}checked{/if}/></td></tr> *}
                                                {* SalesPlatform.ru end *}
                                        {* SalesPlatform.ru begin *}
                                        <tr><td><label class="muted pull-right marginRight10px">{vtranslate('LBL_CONNECTION_SECURITY', $QUALIFIED_MODULE)}</label></td>
