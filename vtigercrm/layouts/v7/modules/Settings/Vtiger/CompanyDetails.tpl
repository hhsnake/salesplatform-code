...
{strip}
	...
	<div class=" col-lg-12 col-md-12 col-sm-12">
		...
		<div class="clearfix">
            ...
            <div class="btn-group pull-left editbutton-container">
                <button id="deleteCompany" class="btn btn-danger {if $SELECTED_COMPANY eq Settings_Vtiger_CompanyDetails_Model::getDefaultCompanyType()}hide{/if}">{vtranslate('LBL_DELETE', $QUALIFIED_MODULE)}</button>
            </div>
            {* SalesPlatform.ru end *}
			<div class="btn-group pull-right editbutton-container">
                {* SalesPlatform.ru begin *}
                <button id="createCompany" class="btn btn-success marginRight10px">{vtranslate('LBL_CREATE_NEW_COMPANY', $QUALIFIED_MODULE)}</button>
                {* SalesPlatform.ru end *}
