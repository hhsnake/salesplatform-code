				...
				<div class="block">
					...
					<table class="table editview-table no-border">
						<tbody>
                            ...
                            <tr>
                                <td class="{$WIDTHTYPE} fieldLabel"style="width:25%"><label>{vtranslate('LBL_SENDMAIL', $QUALIFIED_MODULE)}</label></td>
                                <td class="{$WIDTHTYPE} fieldValue"><span>{if $MODEL->isUseSendMailEnabled() neq 'false'}{vtranslate('LBL_YES', $QUALIFIED_MODULE)} {else}{vtranslate('LBL_NO', $QUALIFIED_MODULE)}{/if}</span></td>
                            </tr>
                            <tr>
                                <td class="{$WIDTHTYPE} fieldLabel"style="width:25%"><label>{vtranslate('LBL_USE_MAIL_ACCOUNT', $QUALIFIED_MODULE)}</label></td>
                                <td class="{$WIDTHTYPE} fieldValue"><span>{if $MODEL->isUseMailAccountEnabled() neq 'false'}{vtranslate('LBL_YES', $QUALIFIED_MODULE)} {else}{vtranslate('LBL_NO', $QUALIFIED_MODULE)}{/if}</span></td>
                            </tr>
                            ...
                            {* SalesPlatform.ru begin*}
                            <tr>
                                <td class="{$WIDTHTYPE} fieldLabel"style="width:25%" ><label>{vtranslate('LBL_SERVER_PORT', $QUALIFIED_MODULE)}</label></td>
                                <td class="{$WIDTHTYPE} fieldValue"><span>{$MODEL->get('server_port')}</span></td>
                            </tr>
                            {* SalesPlatform.ru end*}
							<tr>
                            ...
                            {* SalesPlatform.ru begin*}
                            <tr>
                                <td class="{$WIDTHTYPE} fieldLabel"><label>{vtranslate('LBL_CONNECTION_SECURITY', $QUALIFIED_MODULE)}</label></td>
                                <td class="{$WIDTHTYPE} fieldValue"><span>{if $MODEL->get('server_tls') eq 'tls'}{vtranslate('LBL_TLS', $QUALIFIED_MODULE)} {elseif $MODEL->get('server_tls') eq 'ssl'}{vtranslate('LBL_SSL', $QUALIFIED_MODULE)} {else} {vtranslate('LBL_NO_TLS', $QUALIFIED_MODULE)}{/if}</span></td>
                            </tr>
                            {* SalesPlatform.ru end*}
						</tbody>
					</table>
