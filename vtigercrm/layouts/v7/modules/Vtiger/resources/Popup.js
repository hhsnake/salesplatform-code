...
jQuery.Class("Vtiger_Popup_Js",{
    ...
    // Salesplatform.ru begin SPSocialConnector porting
    showWindow : function(urlOrParams, cb, windowName, eventName, onLoadCb){
            ...
            var popupWinRef =  window.open(url, windowName ,'width=650,height=345,resizable=0,scrollbars=1');
    ...
    // Salesplatform.ru end SPSocialConnector porting
