		...
		<div class="app-list row">
			...
			<div class="dropdown app-modules-dropdown-container dropdown-compact">
				...
				<ul class="dropdown-menu app-modules-dropdown dropdown-modules-compact" aria-labelledby="{$APP_NAME}_modules_dropdownMenu" data-height="0.34">
                    ...
                    {assign var=PDFTEMPLATES_MODULE_MODEL value=Vtiger_Module_Model::getInstance('SPPDFTemplates')}
					{if $PDFTEMPLATES_MODULE_MODEL && $USER_PRIVILEGES_MODEL->hasModulePermission($PDFTEMPLATES_MODULE_MODEL->getId())}
						<li>
							<a href="{$PDFTEMPLATES_MODULE_MODEL->getDefaultUrl()}">
								<span class="fa vicon-documents module-icon"></span>
								<span class="module-name textOverflowEllipsis"> {vtranslate($PDFTEMPLATES_MODULE_MODEL->getName(), $PDFTEMPLATES_MODULE_MODEL->getName())}</span>
							</a>
						</li>
					{/if}
