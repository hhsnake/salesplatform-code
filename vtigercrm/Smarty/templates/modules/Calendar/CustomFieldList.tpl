	...
	<div align=center>
			...
			{/if}
				...
				<table class="settingsSelUITopLine" border="0" cellpadding="5" cellspacing="0" width="100%" >
					<tbody>
						<tr align="left">
							<td rowspan="2" valign="top" width="50"><img src="{'custom.gif'|@vtiger_imageurl:$THEME}" alt="{$MOD.LBL_CUSTOM_FIELD_SETTINGS}" title="{$MOD.LBL_CUSTOM_FIELD_SETTINGS}" border="0" height="48" width="48" onmouseover="tooltip.tip(this,'{$MOD.LEADS_CUSTOM_FIELD_MAPPING}');" onmouseout="tooltip.untip(true);"></td>
