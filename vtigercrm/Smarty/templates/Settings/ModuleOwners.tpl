...
<br>
	<div align=center>
			...
			<tr>
					<td width=50 rowspan=2 valign=top><img src="{'assign.gif'|@vtiger_imageurl:$THEME}" alt="{$MOD.LBL_MODULE_OWNERS}" width="48" height="48" border=0 title="{$MOD.LBL_MODULE_OWNERS}"></td>
