...
$focus->initSortbyField('Consignment');
// END
...
$_SESSION['CONSIGNMENT_ORDER_BY'] = $order_by;
$_SESSION['CONSIGNMENT_SORT_ORDER'] = $sorder;
//<<<<<<<<<<<<<<<<<<< sorting - stored in session >>>>>>>>>>>>>>>>>>>>

//<<<<cutomview>>>>>>>
$oCustomView = new CustomView("Consignment");
...
if(isPermitted('Consignment','Delete','') == 'yes')
{
	$other_text['del'] = $app_strings[LBL_MASS_DELETE];
}
if(isPermitted('Consignment','EditView','') == 'yes')
{
...
if(isset($order_by) && $order_by != '')
{
	if($order_by == 'smownerid')
        ...
        {
		$tablename = getTableNameForField('Consignment',$order_by);
...
$navigationOutput = getTableHeaderSimpleNavigation($navigation_array, $url_string,"Consignment","index",$viewid);
