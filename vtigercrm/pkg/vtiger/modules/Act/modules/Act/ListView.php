...
$_SESSION['ACT_ORDER_BY'] = $order_by;
$_SESSION['ACT_SORT_ORDER'] = $sorder;
//<<<<<<<<<<<<<<<<<<< sorting - stored in session >>>>>>>>>>>>>>>>>>>>

//<<<<cutomview>>>>>>>
$oCustomView = new CustomView("Act");
...
if(isPermitted('Act','Delete','') == 'yes')
{
	$other_text['del'] = $app_strings[LBL_MASS_DELETE];
}
if(isPermitted('Act','EditView','') == 'yes')
{
...
if(isset($order_by) && $order_by != '')
{
	if($order_by == 'smownerid')
        ...
        {
		$tablename = getTableNameForField('Act',$order_by);
...
$navigationOutput = getTableHeaderSimpleNavigation($navigation_array, $url_string,"Act","index",$viewid);
