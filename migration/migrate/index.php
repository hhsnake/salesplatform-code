					...
					<div class="row-fluid">
						...
						<div class="span8">
							...
							<div>
								...
								<p>
									<strong> Предупреждение: </strong>Пожалуйста, учтите что возврат к SalesPlatform Vtiger <?php echo $vtiger_current_version?> невозможен после обновления до SalesPlatform Vtiger 6.2.0-201505 <br><br>
								...
								<form action="index.php" method="POST">
									<div><input type="checkbox" id="checkBox1" name="checkBox1"/> <div class="chkbox"></div> Я сделал(-а) бэкап базы данных <a href="http://salesplatform.ru/wiki/index.php/SalesPlatform_vtiger_crm_620_%D0%9C%D0%B8%D0%B3%D1%80%D0%B0%D1%86%D0%B8%D1%8F" target="_blank" >(руководство)</a> </div><br>
									<div><input type="checkbox" id="checkBox2" name="checkBox2"/> <div class="chkbox"></div> Я сделал(-а) бэкап папки с исходным кодом <a href="http://salesplatform.ru/wiki/index.php/SalesPlatform_vtiger_crm_620_%D0%9C%D0%B8%D0%B3%D1%80%D0%B0%D1%86%D0%B8%D1%8F" target="_blank" >(руководство)</a></div><br>
									<br><div>
										<span id="error"></span>
							...
							<div><br><br><br><br><br>
								...
								<p>
									...
									Пожалуйста, обновите версию системы до <strong>SalesPlatform Vtiger 5.4.0-201310</strong> перед тем как использовать Менеджер миграции. <a href="http://salesplatform.ru/wiki/index.php/SalesPlatform_vtiger_crm_620_%D0%9C%D0%B8%D0%B3%D1%80%D0%B0%D1%86%D0%B8%D1%8F" target="_blank" >(руководство)</a>
								</p>
								<br><br><br><br>
								<div class="button-container">
