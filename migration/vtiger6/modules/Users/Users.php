	...
	public static function getPackagesList() {
		$restrictedModulesList = array('Emails', 'ModComments', 'Rss', 'Portal', 'Integration',
			...
			'Marketing' => array(
				...
				'description' => 'Рассылка сообщений по вашему списку контактов, привлечение потенциальныз покупателей и клиентов, инструменты для анализа и повышения эффективности работы кампании.',
				'modules' => array(
                                        'Campaigns' => 'Кампании'
                                )),
